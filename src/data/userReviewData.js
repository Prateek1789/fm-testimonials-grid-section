...
const userReviewData = [
    {
        ...
        color: 'bg-Purple-500',
        image: images.danielImage,
        backgroundImage: images.bgQuote,
      },
      {
